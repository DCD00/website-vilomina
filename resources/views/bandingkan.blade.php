    ...
    <form action="{{ route('compare') }}" method="POST">
        ...
        <div class="row pt-5">
            <div class="d-flex justify-content-center">
                <img class="mb-4" src="/img/VilominaLogoIcon2.png" alt="" width="116" height="116">
            </div>
        </div>
        <div class="row pt-2">
            <div class="col-md-6">
        ...
        <button type="submit" class="btn text-white" style="background-color: #1BB3A7">Bandingkan</button>
        </div>
    </form>
</div>
@endsection